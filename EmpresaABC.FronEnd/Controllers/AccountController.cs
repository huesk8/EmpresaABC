...
namespace EmpresaABC.FronEnd.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                var user = await _db.Users.FirstOrDefaultAsync(x => x.Mail == model.Email);

                if (user != null)
                    model.Email = user.UserName;
                else
                {
                    Warning("Operación Incorrecta", "Contraseña Incorrecta o El Usuario no existe", true, null);
                    return View(model);
                }
            }
        ...
        [AllowAnonymous]
        public ActionResult AccessCorrect()
        {
            return View();
        }
